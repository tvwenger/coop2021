...
Bayesian MCMC with parallax as a model parameter using priors from Reid et al. (2019)
...
def run_MCMC(
    ...
    Inputs:
      ...
      num_samples :: scalar (int)
        Number of parallax samples per source
        ! No longer a true parameter in this program. Will be set to 1
      prior_set :: string
    ...
    with pm.Model() as model:
        ...
        plx = pm.Normal("plx", mu=plx, sigma=e_plx)  # mas/yr
